document.addEventListener('DOMContentLoaded', () => {
    ...
    const mockPropertyDB = {
        'prop1': {
            ...
            gallery: [
                ...
                'https://via.placeholder.com/150x100?text=Drone',
                'https://via.placeholder.com/150x100?text=Sede'
            ],
            ...
            aptidao: 'Pecuária',
            topografia: 'Ondulada',
            description: '<p>Excelente fazenda com 350 hectares, ideal para pecuária de corte ou leite. Pastagem formada e piqueteada, com várias nascentes e um rio que corta a propriedade.</p><p>Possui casa sede de alvenaria, curral completo com brete e balança, e energia elétrica. Ótimo acesso, a apenas 15km do asfalto.</p>',
        ...
        'prop2': {
            ...
            gallery: ['https://via.placeholder.com/150x100?text=Foto+2'],
            ...
            aptidao: 'Agricultura',
            topografia: 'Plana',
            description: '<p>Lindo sítio com 40 hectares de área total, sendo 30 hectares de área de plantio mecanizável. Terra roxa de alta produtividade.</p><p>Conta com casa sede mista, galpão para maquinário, poço artesiano e sinal de internet fibra óptica. Perfeito para quem busca produzir e morar bem.</p>',
        ...
        'prop3': {
            ...
            gallery: [
                'https://via.placeholder.com/150x100?text=Piscina',
                'https://via.placeholder.com/150x100?text=Nascente'
            ],
            ...
            description: '<p>Chácara espetacular em condomínio fechado. Possui 5 hectares de área verde nativa, com uma bela nascente e um açude piscoso.</p><p>A casa principal é nova e moderna, com piscina aquecida e área gourmet. Internet fibra óptica instalada. Ideal para moradia ou lazer de fim de semana.</p>',
            hidricos_sim: ['Nascente', 'Açude'],
            hidricos_nao: [],
            infra_sim: ['Internet', 'Piscina', 'Casa de Hóspedes', 'Energia Elétrica'],
            infra_nao: ['Curral', 'Galpão']
        }
    };

    // Lista de todas as infraestruturas possíveis
    const allInfra = ['Casa Sede', 'Casa de Hóspedes', 'Curral', 'Galpão', 'Cercada', 'Energia Elétrica', 'Internet', 'Piscina'];
    ...
    function renderPage(property) {
        if (!property) {
            document.querySelector('.property-main-info').innerHTML = '<h1>Imóvel não encontrado</h1><p>O imóvel que você está procurando não existe ou foi removido.</p>';
            return;
        }

        // Preenche Título, Preço, Localização
        document.getElementById('imovel-title').textContent = property.title;
        document.getElementById('imovel-price').textContent = formatCurrency(property.price);
        document.getElementById('imovel-location').textContent = property.location;
        
        // Preenche Descrição
        document.getElementById('imovel-description').innerHTML = property.description;
        ...
        if (detailsList) {
            detailsList.innerHTML = `
                <li><strong>Preço</strong> ${formatCurrency(property.price)}</li>
        ...
        renderFeatureList('recursos-hidricos-list', allHidricos, property.hidricos_sim, property.hidricos_nao);
        renderFeatureList('infraestrutura-list', allInfra, property.infra_sim, property.infra_nao);
    }
