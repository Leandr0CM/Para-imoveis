...
const mockPecuariaDestaques = [
    ...
    { id: 'pec3', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Fazenda+Gado+Corte', badge: null, price: 6200000, title: 'Fazenda Gado de Corte', location: 'Tibagi, PR', features: ['480 ha', 'Mangueira', 'Balança'], link: '/pages/imovel/imovel.html', hasVideoDrone: false, isGeoreferenced: true, hasCAR: true },
    { id: 'pec4', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Sitio+Ovelhas', badge: 'Oportunidade', price: 750000, title: 'Sítio Ovinocultura', location: 'Palmeira, PR', features: ['30 ha', 'Aprisco', 'Pasto Cercado'], link: '/pages/imovel/imovel.html', hasVideoDrone: false, isGeoreferenced: false, hasCAR: false },
    { id: 'pec5', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Area+Pasto+Rotacionado', badge: null, price: 2100000, title: 'Área Pasto Rotacionado', location: 'Lapa, PR', features: ['120 ha', 'Piquetes', 'Bebedouros'], link: '/pages/imovel/imovel.html', hasVideoDrone: false, isGeoreferenced: true, hasCAR: true },
    { id: 'pec6', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Fazenda+Confinamento', badge: null, price: 10500000, title: 'Estrutura Confinamento Bovino', location: 'Arapoti, PR', features: ['150 ha', 'Galpões Confin.', 'Fábrica Ração'], link: '/pages/imovel/imovel.html', hasVideoDrone: true, isGeoreferenced: true, hasCAR: true },
    { id: 'pec7', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Sitio+Haras', badge: 'Destaque', price: 3200000, title: 'Sítio Haras Formado', location: 'São Luiz do Purunã, PR', features: ['20 ha', 'Baias', 'Pista Treino'], link: '/pages/imovel/imovel.html', hasVideoDrone: true, isGeoreferenced: false, hasCAR: true },
    { id: 'pec8', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Fazenda+Leite+A2', badge: null, price: 8800000, title: 'Fazenda Leite A2 Certificada', location: 'Witmarsum, PR', features: ['200 ha', 'Ordenha Robotizada', 'Tanque 10mil L'], link: '/pages/imovel/imovel.html', hasVideoDrone: false, isGeoreferenced: true, hasCAR: true },
];
...
const mockAgriculturaDestaques = [
    ...
    { id: 'agr3', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Area+Plantio+Milho', badge: null, price: 5500000, title: 'Área Plana para Plantio', location: 'Ipiranga, PR', features: ['250 ha', 'Terra Roxa', 'Acesso Fácil'], link: '/pages/imovel/imovel.html', hasVideoDrone: false, isGeoreferenced: true, hasCAR: true },
    { id: 'agr4', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Sitio+Hortifruti', badge: 'Novo', price: 680000, title: 'Sítio Hortifruti c/ Estufa', location: 'Mandirituba, PR', features: ['15 ha', 'Estufa', 'Irrigação'], link: '/pages/imovel/imovel.html', hasVideoDrone: false, isGeoreferenced: false, hasCAR: false, hasOutorgaAgua: true },
    { id: 'agr5', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Fazenda+Trigo', badge: 'Destaque', price: 9100000, title: 'Fazenda de Trigo Irrigada', location: 'Guarapuava, PR', features: ['600 ha', 'Pivô Central', 'Sede Completa'], link: '/pages/imovel/imovel.html', hasVideoDrone: true, isGeoreferenced: true, hasCAR: true, hasOutorgaAgua: true },
    { id: 'agr6', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Sitio+Organico', badge: null, price: 1500000, title: 'Sítio Orgânico Certificado', location: 'Contenda, PR', features: ['18 ha', 'Pomar Orgânico', 'Casa Colonial'], link: '/pages/imovel/imovel.html', hasVideoDrone: false, isGeoreferenced: false, hasCAR: true },
    { id: 'agr7', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Fazenda+Cafe', badge: null, price: 12000000, title: 'Fazenda Café Especial', location: 'Norte Pioneiro, PR', features: ['180 ha', 'Terreiro Concreto', 'Secador'], link: '/pages/imovel/imovel.html', hasVideoDrone: true, isGeoreferenced: true, hasCAR: true },
    { id: 'agr8', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Area+Plantio+Batata', badge: 'Oportunidade', price: 4300000, title: 'Área Plantio Batata/Cebola', location: 'Irati, PR', features: ['90 ha', 'Solo Corrigido', 'Próx. Rodovia'], link: '/pages/imovel/imovel.html', hasVideoDrone: false, isGeoreferenced: true, hasCAR: true, hasAnaliseSolo: true },
];

const mockArrendamentoDestaques = [
    { id: 'arr1', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Area+Arrendar+Soja', badge: 'Destaque', price: 80, priceSuffix: ' sc/ha/ano', title: 'Área para Arrendar - Soja/Milho', location: 'Maripá, PR', features: ['300 ha', 'Terra Plana', 'Contrato 5 anos'], link: '/pages/imovel/imovel.html', isGeoreferenced: true, hasCAR: true },
    { id: 'arr2', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Pasto+Arrendar+Gado', badge: null, price: 50, priceSuffix: ' R$/cab/mês', title: 'Pasto para Arrendar - Bovinos', location: 'Rio Negro, PR', features: ['150 ha', 'Cercado', 'Água encanada'], link: '/pages/imovel/imovel.html', hasCAR: true },
    { id: 'arr3', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Chacara+Arrendar', badge: 'Novo', price: 2500, priceSuffix: ' R$/mês', title: 'Chácara para Arrendar - Lazer', location: 'São José dos Pinhais, PR', features: ['2 ha', 'Casa Mobiliada', 'Piscina'], link: '/pages/imovel/imovel.html' },
    { id: 'arr4', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Area+Arrendar+Reflorestamento', badge: null, price: 1500, priceSuffix: ' R$/ha/ano', title: 'Área p/ Arrendar - Eucalipto', location: 'Cerro Azul, PR', features: ['80 ha', 'Acesso Estrada', 'Topografia Mista'], link: '/pages/imovel/imovel.html', hasCAR: true },
    { id: 'arr5', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Fazenda+Arrendar+Cana', badge: null, price: 90, priceSuffix: ' ton/alq/ano', title: 'Fazenda Arrendamento Cana', location: 'Umuarama, PR', features: ['400 ha', 'Próx. Usina', 'Contrato Longo'], link: '/pages/imovel/imovel.html', isGeoreferenced: true, hasCAR: true },
    { id: 'arr6', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Sitio+Arrendar+Cavalo', badge: 'Destaque', price: 3500, priceSuffix: ' R$/mês', title: 'Sítio Arrendar Centro Treinamento', location: 'Balsa Nova, PR', features: ['10 ha', 'Redondel', 'Piquetes'], link: '/pages/imovel/imovel.html' },
    { id: 'arr7', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Area+Arrendar+Pinus', badge: null, price: 1200, priceSuffix: ' R$/ha/ano', title: 'Área Arrendar p/ Pinus', location: 'Jaguariaíva, PR', features: ['200 ha', 'Fácil Acesso', 'Relevo Suave'], link: '/pages/imovel/imovel.html', hasCAR: true },
    { id: 'arr8', imgSrc: 'https://via.placeholder.com/600x400/cccccc/888888?text=Area+Arrendar+Hortifruti', badge: null, price: 4000, priceSuffix: ' R$/mês', title: 'Área c/ Estufa p/ Arrendar', location: 'Araucária, PR', features: ['5 ha', 'Estufas Prontas', 'Irrigação ok'], link: '/pages/imovel/imovel.html', hasOutorgaAgua: true },
];
