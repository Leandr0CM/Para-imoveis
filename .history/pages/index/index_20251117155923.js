...
const mockPecuariaDestaques = [
  {
    id: "pec1",
    imgSrc:
      "https://images.unsplash.com/photo-1596924036923-9e3d84f4756b?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600&h=400&fit=crop",
    badge: "Destaque",
    price: 4500000,
    title: "Fazenda Pronta para Pecuária",
    location: "Bocaiúva do Sul, PR",
    features: ["350 ha", "Casa Sede", "Curral"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: true,
  ...
  },
  {
    id: "pec2",
    imgSrc:
      "https://images.unsplash.com/photo-1593452095210-2f61a19f074b?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600&h=400&fit=crop",
    badge: null,
    price: 950000,
    title: "Sítio Leiteiro Equipado",
    location: "Carambeí, PR",
    features: ["25 ha", "Curral Leite", "Resfriador"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: false,
  ...
  },
  {
    ...
    location: "Tibagi, PR",
    features: ["480 ha", "Mangueira", "Balança"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: false,
    isGeoreferenced: true,
    hasCAR: true,
  },
  {
    ...
    features: ["30 ha", "Aprisco", "Pasto Cercado"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: false,
    isGeoreferenced: false,
    hasCAR: false,
  },
  {
    ...
    location: "Lapa, PR",
    features: ["120 ha", "Piquetes", "Bebedouros"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: false,
    isGeoreferenced: true,
    hasCAR: true,
  },
  {
    ...
    location: "Arapoti, PR",
    features: ["150 ha", "Galpões Confin.", "Fábrica Ração"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: true,
    isGeoreferenced: true,
    hasCAR: true,
  },
  {
    ...
    location: "São Luiz do Purunã, PR",
    features: ["20 ha", "Baias", "Pista Treino"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: true,
    isGeoreferenced: false,
    hasCAR: true,
  },
  {
    ...
    location: "Witmarsum, PR",
    features: ["200 ha", "Ordenha Robotizada", "Tanque 10mil L"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: false,
    isGeoreferenced: true,
    hasCAR: true,
...
const mockAgriculturaDestaques = [
  {
    id: "agr1",
    imgSrc:
      "https://images.unsplash.com/photo-1444858291040-5c7f113a1eb1?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600&h=400&fit=crop",
    badge: null,
    price: 1200000,
    title: "Sítio para Agricultura Familiar",
    location: "Castro, PR",
    features: ["40 ha", "Casa Sede", "Galpão"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: false,
    isGeoreferenced: false,
    hasCAR: true,
  },
  {
    id: "agr2",
    imgSrc:
      "https://images.unsplash.com/photo-1500382017468-9049fed747ef?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600&h=400&fit=crop",
    badge: "Destaque",
    price: 7800000,
    title: "Fazenda de Soja Produtiva",
    location: "Ponta Grossa, PR",
    features: ["500 ha", "Silo", "Barracão"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: true,
    isGeoreferenced: true,
    hasCAR: true,
  ...
  },
  {
    ...
    features: ["250 ha", "Terra Roxa", "Acesso Fácil"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: false,
    isGeoreferenced: true,
    hasCAR: true,
  },
  {
    ...
    features: ["15 ha", "Estufa", "Irrigação"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: false,
    isGeoreferenced: false,
    hasCAR: false,
  ...
  },
  {
    ...
    features: ["600 ha", "Pivô Central", "Sede Completa"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: true,
    isGeoreferenced: true,
    hasCAR: true,
  ...
  },
  {
    ...
    features: ["18 ha", "Pomar Orgânico", "Casa Colonial"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: false,
    isGeoreferenced: false,
    hasCAR: true,
  },
  {
    ...
    features: ["180 ha", "Terreiro Concreto", "Secador"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: true,
    isGeoreferenced: true,
    hasCAR: true,
  },
  {
    ...
    location: "Irati, PR",
    features: ["90 ha", "Solo Corrigido", "Próx. Rodovia"],
    link: "/pages/imovel/imovel.html",
    hasVideoDrone: false,
    isGeoreferenced: true,
    hasCAR: true,
...
const mockArrendamentoDestaques = [
  {
    ...
    title: "Área para Arrendar - Soja/Milho",
    location: "Maripá, PR",
    features: ["300 ha", "Terra Plana", "Contrato 5 anos"],
    link: "/pages/imovel/imovel.html",
    isGeoreferenced: true,
    hasCAR: true,
  },
  {
    ...
    title: "Pasto para Arrendar - Bovinos",
    location: "Rio Negro, PR",
    features: ["150 ha", "Cercado", "Água encanada"],
    link: "/pages/imovel/imovel.html",
    hasCAR: true,
  },
  {
    ...
    price: 2500,
    priceSuffix: " R$/mês",
    title: "Chácara para Arrendar - Lazer",
    location: "São José dos Pinhais, PR",
    features: ["2 ha", "Casa Mobiliada", "Piscina"],
    link: "/pages/imovel/imovel.html",
  },
  {
    id: "arr4",
    ...
    title: "Área p/ Arrendar - Eucalipto",
    location: "Cerro Azul, PR",
    features: ["80 ha", "Acesso Estrada", "Topografia Mista"],
    link: "/pages/imovel/imovel.html",
    hasCAR: true,
  },
  {
    ...
    title: "Fazenda Arrendamento Cana",
    location: "Umuarama, PR",
    features: ["400 ha", "Próx. Usina", "Contrato Longo"],
    link: "/pages/imovel/imovel.html",
    isGeoreferenced: true,
    hasCAR: true,
  },
  {
    ...
    price: 3500,
    priceSuffix: " R$/mês",
    title: "Sítio Arrendar Centro Treinamento",
    location: "Balsa Nova, PR",
    features: ["10 ha", "Redondel", "Piquetes"],
    link: "/pages/imovel/imovel.html",
  },
  {
    id: "arr7",
    ...
    price: 1200,
    priceSuffix: " R$/ha/ano",
    title: "Área Arrendar p/ Pinus",
    location: "Jaguariaíva, PR",
    features: ["200 ha", "Fácil Acesso", "Relevo Suave"],
    link: "/pages/imovel/imovel.html",
    hasCAR: true,
  },
  {
    ...
    price: 4000,
    priceSuffix: " R$/mês",
    title: "Área c/ Estufa p/ Arrendar",
    location: "Araucária, PR",
    features: ["5 ha", "Estufas Prontas", "Irrigação ok"],
    link: "/pages/imovel/imovel.html",
    hasOutorgaAgua: true,
  },
];
...
if (carouselWrappers.length > 0) {
  ...
  function renderCards(gridElement, dataArray) {
    ...
    dataArray.forEach((cardData) => {
      ...
      const featuresHTML = cardData.features
        ...
        .join("");
      const priceDisplay = cardData.priceSuffix
        ? cardData.price.toLocaleString("pt-BR") + cardData.priceSuffix
        : cardData.price.toLocaleString("pt-BR", {
            style: "currency",
            currency: "BRL",
          });
      ...
      let iconsHTML = "";
      if (cardData.hasVideoDrone)
        iconsHTML += `<i class="fa-solid fa-helicopter" title="Vídeo Drone Disponível"></i>`;
      if (cardData.isGeoreferenced)
        iconsHTML += `<i class="fa-solid fa-map-location-dot" title="Georreferenciado (INCRA)"></i>`;
      if (cardData.hasCAR)
        iconsHTML += `<i class="fa-solid fa-file-shield" title="CAR OK/Validado"></i>`;
      if (cardData.hasOutorgaAgua)
        iconsHTML += `<i class="fa-solid fa-droplet" title="Outorga D'água"></i>`;
      if (cardData.hasAnaliseSolo)
        iconsHTML += `<i class="fa-solid fa-flask-vial" title="Análise de Solo Disponível"></i>`;
  ...
  function initializeCarousel(wrapper) {
    ...
    if (!carousel || !listingsGrid || !prevBtn || !nextBtn) {
      console.error("Wrapper incompleto:", wrapper);
      return;
    }
    ...
    else if (carouselId === "carouselAgricultura")
      dataToRender = mockAgriculturaDestaques;
    else if (carouselId === "carouselArrendamento")
      dataToRender = mockArrendamentoDestaques;
    ...
    for (let i = 0; i < clonesCount; i++) {
      if (cardCount - 1 - i >= 0) {
        const clone = originalCards[cardCount - 1 - i].cloneNode(true);
        clone.classList.add("clone", "clone-start");
        listingsGrid.insertBefore(clone, listingsGrid.firstChild);
      }
    }
    ...
    function calculateCardWidthAndPosition() {
      const firstOriginalCard = listingsGrid.querySelector(
        ".property-card:not(.clone)"
      );
      if (!firstOriginalCard) return;
      const cardStyle = window.getComputedStyle(firstOriginalCard);
      const gridStyle = window.getComputedStyle(listingsGrid);
      const gapPixels =
        parseFloat(gridStyle.gap) || parseFloat(cardStyle.marginRight) || 16;
      cardWidth = firstOriginalCard.offsetWidth + gapPixels;
      if (cardWidth > gapPixels) {
        // console.log(`   [${carouselId}] Card width: ${cardWidth.toFixed(0)}px`);
        carousel.style.scrollBehavior = "auto";
        carousel.scrollLeft = cardWidth * clonesCount;
        ...
        console.error(`[${carouselId}] Falha ao calcular cardWidth!`);
      }
    }
    ...
    window.addEventListener("resize", () => {
      ...
      resizeTimeout = setTimeout(() => {
        initialScrollCompleted = false;
        calculateCardWidthAndPosition();
      }, 250);
    });

    // 3. Lógica dos Botões
    nextBtn.addEventListener("click", () => {
      if (isTransitioning || cardWidth === 0 || !initialScrollCompleted) return;
    ...
    carousel.addEventListener("scroll", () => {
      ...
      scrollDebounceTimeout = setTimeout(() => {
        ...
        const lastOriginalStartPosition =
          cardWidth * (cardCount + clonesCount - 1);
        ...
        if (currentScroll >= maxScrollPossible - tolerance) {
          ...
          setTimeout(() => {
            // Delay mínimo para o browser processar o salto
            carousel.style.scrollBehavior = "smooth";
        ...
        // Check do INÍCIO -> Fim
          ...
          // Verifica se chegou perto do início absoluto (0)
  ...
  console.log("Nenhum .carousel-wrapper encontrado.");
}
...
if (heroSearchForm) {
  heroSearchForm.addEventListener("submit", (event) => {
    ...
    const queryString = `tipo=${encodeURIComponent(
      tipoImovel
    )}&aptidao=${encodeURIComponent(aptidao)}&local=${encodeURIComponent(
      localizacao
    )}`;
