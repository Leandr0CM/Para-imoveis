...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (mapBtn && satBtn && mapContainer) {
    mapBtn.addEventListener("click", () => {
      ...
      mapContainer.querySelector("p").textContent =
        "Visualização de MAPA ativada.";
    });
    ...
    satBtn.addEventListener("click", () => {
      ...
      mapContainer.querySelector("p").textContent =
        "Visualização de SATÉLITE ativada.";
    });
  }
  ...
  const mockProperties = [
    ...
    {
      id: "prop4",
      imgSrc: "https://placehold.co/600x400/81c784/ffffff?text=Chacara+Lazer",
      price: 850000,
    ...
    },
    {
      id: "prop5",
      imgSrc:
        "https://placehold.co/600x400/66bb6a/ffffff?text=Arrendamento+Pasto",
